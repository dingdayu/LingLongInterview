...
class IpLocation
{
    ...
    private function getstring($data = "")
    {
        ...
        //echo iconv( "GB2312//IGNORE","UTF-8", $data) ;
        return $data;
    }
    ...
    public function getlocation($ip = '')
    {
            ...
            case 1: // 标志字节为1，表示国家和区域信息都被同时重定向
                ...
                switch (ord($byte)) {
                    ...
                    default: // 否则，表示国家信息没有被重定向
                        ...
                        //echo iconv( "GB2312//IGNORE","UTF-8", $location['country']) ;
                        $location['area']    = $this->getarea();
                        break;
                }
                break;
        ...
        $location['country'] = iconv( "GB2312//IGNORE","UTF-8", $location['country']) ;
        $location['area'] = iconv( "GB2312//IGNORE","UTF-8", $location['area']) ;
        return $location;
    }
